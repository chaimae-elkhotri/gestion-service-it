...
$idUtilisateurEvaluation =
    $evaluation['id_utilisateur']
    ?? $evaluation['ID_UTILISATEUR']
    ?? '';

$idInterventionEvaluation =
...
<div class="module-page">
    ...
    <div class="module-header">
        ...
        <div>
            ...
            <h2>
                <?= htmlspecialchars(
                    evaluationT('edit_title')
                ); ?>
            </h2>

            <p>
                <?= htmlspecialchars(
                    evaluationT('edit_subtitle')
                ); ?>
            </p>
    ...
    <div class="modern-form-card">
        ...
        <form action="<?= BASE_URL ?>?page=mettre-a-jour-evaluation&id=<?= (int)$id; ?>"
              method="POST">
                    ...
                    <select name="id_utilisateur"
                        ...
                        <?php foreach (
                            ...
                            <option value="<?= htmlspecialchars(
                                ...
                                <?= $idUtilisateur == $idUtilisateurEvaluation
                                    ? 'selected'
                                    : ''; ?>>
                    ...
                    <select name="id_intervention"
                        ...
                        <?php foreach (
                            ...
                            <option value="<?= htmlspecialchars(
                                ...
                                <?= $idIntervention == $idInterventionEvaluation
                                    ? 'selected'
                                    : ''; ?>>
